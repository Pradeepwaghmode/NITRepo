...
@Component
public class ZuulPreFilterImpl extends ZuulFilter{

	private Logger logger=LoggerFactory.getLogger(ZuulFilter.class);
	
	public ZuulPreFilterImpl() {
		System.out.println("===================================");
		System.out.println("ZuulPreFilterImpl.ZuulPreFilterImpl()");
		System.out.println("===================================");
	}
	@Override
	...
	public Object run() throws ZuulException {
		// TODO Auto-generated method stub
		logger.info("-- pre filter is executing --");
